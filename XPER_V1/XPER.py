...
In this file we use the data generated with the file "Probit_model" (see the file
...
exec(open('Probit_model.py').read())

# =============================================================================
#                               Packages
# =============================================================================

from sklearn.metrics import roc_auc_score,brier_score_loss,balanced_accuracy_score,accuracy_score,confusion_matrix
import numpy as np
...
p = X_test.shape[1] - 1 # exclude the intercept
...
y_hat_proba = model.predict(X_test) # X_test[:,1:] : exlude the intercept (already added by the function)
...
y_hat_proba_train = model.predict(X_train) # X_train[:,1:] : exlude the intercept (already added by the function)
