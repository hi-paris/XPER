...
## We create the class "model_" to have a method "predict_proba" which gives
## the predicted probability to be equal to 0 and equal to 1. The idea is to have
## the same format for the predicted probability as the one of the XGBoost model.
## Indeed, the code for the computation of XPER values is based on the outputs
