...
class Computation:
    """
    Class used to store the parameters of the XPER algorithm.
    """
    ...
    def calculate_XPER_values(self, X_test, y_test, Model, Eval_Metric, CFP, CFN):
        """
...
c = Computation()
c.verbose = 1
c.evaluate_model_performance(Eval_Metric, X_train, y_train, X_test, y_test, Model)
c.calculate_XPER_values(X_test, y_test, Model, Eval_Metric, CFP, CFN)