...
def train_model_and_calculate_auc(X_train, y_train, X_test, y_test):
    """
    Calculates the AUC (Area Under the Curve) of a model using XGBoost.
    ...
    Raises:
    - ValueError: If the shapes of X_train, y_train, X_test, and y_test are not compatible.
    ...
    parameters = {
        ...
        "colsample_bynode": np.arange(0, 1, 0.1),
...
auc, model = train_model_and_calculate_auc(X_train, y_train, X_test, y_test)
print("AUC: {}".format(auc))
